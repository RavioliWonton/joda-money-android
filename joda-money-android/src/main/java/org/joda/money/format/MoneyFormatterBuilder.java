...
public final class MoneyFormatterBuilder {
     ...
     */
    @NonNull
    public MoneyFormatterBuilder appendAmount(@NonNull MoneyAmountStyle style) {
     ...
     */
    @NonNull
    public MoneyFormatterBuilder appendLiteral(@Nullable CharSequence literal) {
     ...
     */
    @NonNull
    public MoneyFormatterBuilder append(@NonNull MoneyFormatter formatter) {
     ...
     */
    @NonNull
    public MoneyFormatterBuilder append(@Nullable MoneyPrinter printer, @Nullable MoneyParser parser) {
    ...
    public MoneyFormatterBuilder appendSigned(
            @NonNull MoneyFormatter whenPositiveOrZero, @NonNull MoneyFormatter whenNegative) {
    ...
    @NonNull
    public MoneyFormatterBuilder appendSigned(
            @NonNull MoneyFormatter whenPositive, @NonNull MoneyFormatter whenZero, @NonNull MoneyFormatter whenNegative) {
     ...
     */
    @NonNull
    private MoneyFormatterBuilder appendInternal(@Nullable MoneyPrinter printer, @Nullable MoneyParser parser) {
    ...
    public MoneyFormatter toFormatter() {
        return (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) ?
                toFormatter(ULocale.getDefault()) :
    ...
    public MoneyFormatter toFormatter(Locale locale) {
        ...
        MoneyPrinter[] printersCopy = printers.toArray(new MoneyPrinter[0]);
        MoneyParser[] parsersCopy = parsers.toArray(new MoneyParser[0]);
    ...
    @RequiresApi(api = 24)
    @NonNull
    public MoneyFormatter toFormatter(ULocale locale) {
        MoneyFormatter.checkNotNull(locale, "Locale must not be null");
        MoneyPrinter[] printersCopy = printers.toArray(new MoneyPrinter[0]);
        MoneyParser[] parsersCopy = parsers.toArray(new MoneyParser[0]);
        return new MoneyFormatter(locale, printersCopy, parsersCopy);
     ...
     */
    private enum Singletons implements MoneyPrinter, MoneyParser {
        CODE("${code}") {
            @Override
