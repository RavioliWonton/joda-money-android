...
public interface MoneyPrinter {
     ...
     */
    void print(@NonNull MoneyPrintContext context, @NonNull Appendable appendable, @NonNull BigMoney money) throws IOException;
     ...
     * or shared with any other threads.
     *
     * @param context    the icu context being used, not null
     * @param appendable the appendable to add to, not null
     * @param money      the money to print, not null
     * @throws MoneyFormatException if there is a problem while printing
     * @throws IOException          if an IO exception occurs
     */
    @RequiresApi(api = 24)
    void print(@NonNull ICUMoneyPrintContext context, @NonNull Appendable appendable, @NonNull BigMoney money) throws IOException;
