...
public final class MoneyFormatter implements Serializable {
     ...
     */
    MoneyFormatter(@NonNull Locale locale, @NonNull MoneyPrinter[] printers, @NonNull MoneyParser[] parsers) {
        if (BuildConfig.DEBUG) {
            if (locale == null || printers == null || parsers == null || printers.length != parsers.length)
                throw new AssertionError("Assertion failed");
        }
        this.locale = locale;
        this.uLocale = (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) ? ULocale.forLocale(locale) : null;
     ...
     */
    @RequiresApi(api = 24)
    MoneyFormatter(@NonNull ULocale locale, @NonNull MoneyPrinter[] printers, @NonNull MoneyParser[] parsers) {
        if (BuildConfig.DEBUG) {
            if (locale == null || printers == null || parsers == null || printers.length != parsers.length)
                throw new AssertionError("Assertion failed");
        }
     ...
     */
    private MoneyFormatter(@NonNull Locale locale, @NonNull MultiPrinterParser printerParser) {
        if (BuildConfig.DEBUG) {
            if (locale == null || printerParser == null)
                throw new AssertionError("Assertion failed");
        }
        this.locale = locale;
        this.uLocale = (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) ? ULocale.forLocale(locale) : null;
     ...
     */
    @RequiresApi(api = 24)
    private MoneyFormatter(@NonNull ULocale locale, @NonNull MultiPrinterParser printerParser) {
        if (BuildConfig.DEBUG) {
            if (locale == null || printerParser == null)
                throw new AssertionError("Assertion failed");
        }
     ...
     */
    static void checkNotNull(@Nullable Object object, @NonNull String message) {
        if (object == null) {
     ...
     */
    @NonNull
    public MoneyFormatter withLocale(@NonNull Locale locale) {
    ...
    @NonNull
    @RequiresApi(api = 24)
    public MoneyFormatter withULocale(@NonNull ULocale locale) {
        checkNotNull(locale, "Locale must not be null");
        return new MoneyFormatter(locale, printerParser);
    }
     ...
     */
    public String print(@NonNull BigMoneyProvider moneyProvider) {
     ...
     * @throws MoneyFormatException          if there is a problem while printing
     */
    public void print(@NonNull Appendable appendable, @NonNull BigMoneyProvider moneyProvider) {
        try {
     ...
     */
    public void printIO(@NonNull Appendable appendable, @NonNull BigMoneyProvider moneyProvider) throws IOException {
        checkNotNull(moneyProvider, "BigMoneyProvider must not be null");
        if (!isPrinter()) {
            throw new UnsupportedOperationException("MoneyFormatter has not been configured to be able to print");
        }
     ...
     */
    @NonNull
    public BigMoney parseBigMoney(@NonNull CharSequence text) {
        checkNotNull(text, "Text must not be null");
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ICUMoneyParseContext result = parseICU(text, 0);
     ...
     */
    @NonNull
    public Money parseMoney(@NonNull CharSequence text) {
     ...
     */
    @NonNull
    public MoneyParseContext parse(@NonNull CharSequence text, int startIndex) {
        checkNotNull(text, "Text must not be null");
    ...
    @RequiresApi(api = 24)
    @NonNull
    public ICUMoneyParseContext parseICU(@NonNull CharSequence text, int startIndex) {
        checkNotNull(text, "Text must not be null");
        if (startIndex < 0 || startIndex > text.length()) {
            throw new StringIndexOutOfBoundsException("Invalid start index: " + startIndex);
        }
        ...
        ICUMoneyParseContext context;
        if (uLocale != null)
            context = new ICUMoneyParseContext(uLocale, text, startIndex);
        else if (locale != null)
            context = new ICUMoneyParseContext(ULocale.forLocale(locale), text, startIndex);
        else throw new IllegalArgumentException("Locale null");
        printerParser.parse(context);
        return context;
    }
