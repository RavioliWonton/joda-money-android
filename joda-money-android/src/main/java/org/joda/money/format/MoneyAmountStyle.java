...
public final class MoneyAmountStyle implements Serializable {
    ...
    /**
     * Cache of ICU-variant localized styles.
     */
    private static final ConcurrentMap<ULocale, MoneyAmountStyle> ICU_LOCALIZED_CACHE = new ConcurrentHashMap<>();
    /**
     ...
     */
    public static MoneyAmountStyle of(@NonNull Locale locale) {
    ...
    @RequiresApi(api = 24)
    @NonNull
    public static MoneyAmountStyle of(@NonNull ULocale locale) {
        return getLocalizedStyle(locale);
    }
     ...
     */
    @NonNull
    private static MoneyAmountStyle getLocalizedStyle(@NonNull Locale locale) {
     ...
     * Gets the prototype localized style for the given locale.
     * <p>
     * This uses {@link android.icu.text.DecimalFormatSymbols} and {@link android.icu.text.NumberFormat}.
     * <p>
     * The method {@code DecimalFormatSymbols.getInstance(locale)} will be used
     * in order to allow the use of locales defined as extensions.
     *
     * @param locale the {@link ULocale} used to get the correct {@link android.icu.text.DecimalFormatSymbols}
     * @return the symbols, never null
     */
    @RequiresApi(api = 24)
    @NonNull
    private static MoneyAmountStyle getLocalizedStyle(@NonNull ULocale locale) {
        MoneyAmountStyle protoStyle = ICU_LOCALIZED_CACHE.get(locale);
        if (protoStyle == null) {
            android.icu.text.DecimalFormatSymbols symbols = android.icu.text.DecimalFormatSymbols.getInstance(locale);
            android.icu.text.NumberFormat format = android.icu.text.NumberFormat.getCurrencyInstance(locale);
            int size = (format instanceof android.icu.text.DecimalFormat ? ((android.icu.text.DecimalFormat) format).getGroupingSize() : 3);
            size = size <= 0 ? 3 : size;
            protoStyle = new MoneyAmountStyle(
                    symbols.getZeroDigit(),
                    '+',
                    ...
                    false,
                    false);
            ICU_LOCALIZED_CACHE.putIfAbsent(locale, protoStyle);
        }
        return protoStyle;
    }
     ...
     */
    @NonNull
    public MoneyAmountStyle localize(@NonNull Locale locale) {
     ...
     * method has no effect. Once this method is called, no method will return null.
     * <p>
     * The settings for the locale are pulled from {@link android.icu.text.DecimalFormatSymbols} and
     * {@link android.icu.text.DecimalFormat}.
     *
     * @param locale the locale to use, not null
     * @return the new instance for chaining, never null
     */
    @RequiresApi(api = 24)
    @NonNull
    public MoneyAmountStyle localize(@NonNull ULocale locale) {
        MoneyFormatter.checkNotNull(locale, "Locale must not be null");
        MoneyAmountStyle result = this;
        MoneyAmountStyle protoStyle = null;
        if (zeroCharacter < 0) {
     ...
     */
    @NonNull
    public MoneyAmountStyle withZeroCharacter(@Nullable Character zeroCharacter) {
     ...
     */
    @NonNull
    public MoneyAmountStyle withPositiveSignCharacter(@Nullable Character positiveCharacter) {
     ...
     */
    @NonNull
    public MoneyAmountStyle withNegativeSignCharacter(@Nullable Character negativeCharacter) {
     ...
     */
    @NonNull
    public MoneyAmountStyle withDecimalPointCharacter(@Nullable Character decimalPointCharacter) {
     ...
     */
    @NonNull
    public MoneyAmountStyle withGroupingCharacter(@Nullable Character groupingCharacter) {
     ...
     */
    @NonNull
    public MoneyAmountStyle withGroupingSize(@Nullable Integer groupingSize) {
     ...
     */
    @NonNull
    public MoneyAmountStyle withExtendedGroupingSize(@Nullable Integer extendedGroupingSize) {
     ...
     */
    @NonNull
    public MoneyAmountStyle withGroupingStyle(@NonNull GroupingStyle groupingStyle) {
