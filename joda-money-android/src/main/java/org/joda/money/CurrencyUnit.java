 ...
 * or US Dollar.
 * <p>
 * The set of loaded currencies is provided by an instance of {@link BaseCurrencyUnitDataProvider}.
 * The provider used is determined by the system property {@code org.joda.money.CurrencyUnitDataProvider}
 * which should be the fully qualified class name of the provider. The default provider loads the
 * resource named {@code /assets/MoneyData.csv} on the classpath.
 * <p>
 * This class is immutable and thread-safe.
 */
public final class CurrencyUnit implements Comparable<CurrencyUnit>, Serializable, Parcelable {
    ...
    protected CurrencyUnit(Parcel in) {
        code = in.readString();
        numericCode = (short) in.readInt();
        decimalPlaces = (short) in.readInt();
    }
     ...
     */
    CurrencyUnit(@NonNull String code, short numericCode, short decimalPlaces) {
    ...
    public static synchronized CurrencyUnit registerCurrency(
            @NonNull String currencyCode, int numericCurrencyCode, int decimalPlaces, @NonNull List<String> countryCodes) {
     ...
     */
    public static synchronized CurrencyUnit registerCurrency(
            @NonNull String currencyCode, int numericCurrencyCode, int decimalPlaces, @NonNull List<String> countryCodes, boolean force) {
     ...
     * @param currency    the associated currency, not null
     */
    public static synchronized void registerCountry(@NonNull String countryCode, @NonNull CurrencyUnit currency) {
     ...
     */
    @NonNull
    public static CurrencyUnit of(@NonNull Currency currency) {
        MoneyUtils.checkNotNull(currency, "Currency must not be null");
        return of(currency.getCurrencyCode());
    }

    /**
     * Obtains an instance of {@code CurrencyUnit} matching the specified ICU currency
     * in Android SDK above API 24.
     * <p>
     * This converts the ICU currency instance to a currency unit using the code.
     *
     * @param currency the currency, not null
     * @return the singleton instance, never null
     * @throws IllegalCurrencyException if the currency is unknown
    ...
    @NonNull
    @RequiresApi(api = 24)
    public static CurrencyUnit of(@NonNull android.icu.util.Currency currency) {
        MoneyUtils.checkNotNull(currency, "Currency must not be null");
        return of(currency.getCurrencyCode());
    }
    ...
    @FromString
    @NonNull
    public static CurrencyUnit of(@NonNull String currencyCode) {
        MoneyUtils.checkNotNull(currencyCode, "Currency code must not be null");
     ...
     */
    @NonNull
    public static CurrencyUnit ofNumericCode(@NonNull String numericCurrencyCode) {
     ...
     */
    @NonNull
    public static CurrencyUnit of(@NonNull Locale locale) {
    ...
    /**
     * Obtains an instance of {@code CurrencyUnit} for the specified ULocale from ICU.
     * <p>
     * Only the country is used from the locale.
     *
     * @param locale the ULocale, not null
     * @return the singleton instance, never null
     * @throws IllegalCurrencyException if the currency is unknown
     */
    @NonNull
    @RequiresApi(api = 24)
    public static CurrencyUnit of(@NonNull ULocale locale) {
        MoneyUtils.checkNotNull(locale, "Locale must not be null");
        CurrencyUnit currency = currenciesByCountry.get(locale.getCountry());
        if (currency == null) {
            throw new IllegalCurrencyException("No currency found for locale '" + locale + '\'');
    ...
    /**
     * Gets the symbol for this locale from the JDK or from ICU library if API
     * Level is above 24.
     * <p>
     * If this currency doesn't have a JDK or ICU equivalent, then the currency
     * code is returned.
     * <p>
    ...
    public String getSymbol() {
        try {
            return Currency.getInstance(code).getSymbol();//Internally modified to use ICU Currency on API Level above 24, see source for more detail.
    ...
    /**
     * Gets the symbol for specified locale from the JDK or from ICU library if API
     * Level is above 24.
     * <p>
     * If this currency doesn't have a JDK or ICU equivalent, then the currency
     * code is returned.
    ...
    public String getSymbol(Locale locale) {
        MoneyUtils.checkNotNull(locale, "Locale must not be null");
        try {
            return Currency.getInstance(code).getSymbol(locale);//Internally modified to use ICU Currency on API Level above 24, see source for more detail.
        } catch (IllegalArgumentException ex) {
            return code;
        }
    }
    ...
    /**
     * Gets the symbol for this locale from the Android built-in ICU from API 24.
     * <p>
     * If retrieve proceed has failed, it will fall to use a JDK currency instance.
     * If this currency doesn't have a ICU or JDK equivalent, then the currency code
     * is returned.
     * <p>
     * This method matches the API of {@link android.icu.util.Currency}.
     *
     * @param ulocale the ULocale to get the symbol for, not null
     * @return the ICU currency instance, never null
     */
    @NonNull
    @RequiresApi(api = 24)
    public String getSymbol(ULocale ulocale) {
        MoneyUtils.checkNotNull(ulocale, "Locale must not be null");
        try {
            return android.icu.util.Currency.getInstance(code).getSymbol(ulocale);
        } catch (IllegalArgumentException ex1) {
            try {
                return Currency.getInstance(code).getSymbol(ulocale.toLocale());
    ...
    /**
     * Gets the ICU currency instance equivalent to this currency for runtime
     * above API 24.
     * <p>
     * This attempts to convert a {@code CurrencyUnit} to a ICU {@code Currency}.
     *
     * @return the ICU currency instance, never null
     * @throws IllegalArgumentException if no matching currency exists in the ICU
     */
    @NonNull
    @RequiresApi(api = 24)
    public android.icu.util.Currency toICUCurrency() {
