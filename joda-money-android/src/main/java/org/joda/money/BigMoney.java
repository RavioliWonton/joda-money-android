 ...
 */
public final class BigMoney implements BigMoneyProvider, Comparable<BigMoneyProvider>, Serializable, Parcelable {

    /**
     * @see android.os.Parcelable.Creator
     */
    public static final Creator<BigMoney> CREATOR = new Creator<BigMoney>() {
        @Override
        public BigMoney createFromParcel(Parcel in) {
            return new BigMoney(in);
        }

        @Override
        public BigMoney[] newArray(int size) {
            return new BigMoney[size];
        }
    };
    /**
     ...
     */
    protected BigMoney(Parcel in) {
        currency = in.readParcelable(CurrencyUnit.class.getClassLoader());
     ...
     */
    BigMoney(@NonNull CurrencyUnit currency, @NonNull BigDecimal amount) {
        ...
        this.amount = (amount.scale() < 0 ? amount.setScale(0, RoundingMode.UNNECESSARY) : amount);
    }
     ...
     */
    @NonNull
    public static BigMoney of(@NonNull CurrencyUnit currency, @NonNull BigDecimal amount) {
     ...
     */
    @NonNull
    public static BigMoney of(@NonNull CurrencyUnit currency, double amount) {
        MoneyUtils.checkNotNull(currency, "Currency must not be null");
     ...
     */
    @NonNull
    public static BigMoney ofScale(@NonNull CurrencyUnit currency, BigDecimal amount, int scale) {
     ...
     */
    @NonNull
    public static BigMoney ofScale(@NonNull CurrencyUnit currency, @NonNull BigDecimal amount, int scale, @NonNull RoundingMode roundingMode) {
     ...
     */
    @NonNull
    public static BigMoney ofScale(@NonNull CurrencyUnit currency, long unscaledAmount, int scale) {
        MoneyUtils.checkNotNull(currency, "Currency must not be null");
     ...
     */
    @NonNull
    public static BigMoney ofMajor(@NonNull CurrencyUnit currency, long amountMajor) {
        MoneyUtils.checkNotNull(currency, "CurrencyUnit must not be null");
     ...
     */
    @NonNull
    public static BigMoney ofMinor(@NonNull CurrencyUnit currency, long amountMinor) {
        MoneyUtils.checkNotNull(currency, "CurrencyUnit must not be null");
     ...
     */
    @NonNull
    public static BigMoney zero(@NonNull CurrencyUnit currency) {
     ...
     */
    @NonNull
    public static BigMoney zero(@NonNull CurrencyUnit currency, int scale) {
     ...
     */
    @NonNull
    public static BigMoney of(@NonNull BigMoneyProvider moneyProvider) {
     ...
     */
    @NonNull
    public static BigMoney total(@NonNull BigMoneyProvider... monies) {
     ...
     */
    @NonNull
    public static BigMoney total(@NonNull Iterable<? extends BigMoneyProvider> monies) {
     ...
     */
    @NonNull
    public static BigMoney total(@NonNull CurrencyUnit currency, @NonNull BigMoneyProvider... monies) {
    ...
    @FromString
    @NonNull
    public static BigMoney parse(@NonNull String moneyStr) {
     ...
     */
    @NonNull
    public static BigMoney total(@NonNull CurrencyUnit currency, @NonNull Iterable<? extends BigMoneyProvider> monies) {
     ...
     */
    private void readObject(@NonNull ObjectInputStream ois) throws InvalidObjectException {
     ...
     */
    @NonNull
    private BigMoney with(@NonNull BigDecimal newAmount) {
     ...
     */
    @NonNull
    public BigMoney withCurrencyUnit(@NonNull CurrencyUnit currency) {
        MoneyUtils.checkNotNull(currency, "CurrencyUnit must not be null");
     ...
     */
    @NonNull
    public BigMoney withScale(int scale, @NonNull RoundingMode roundingMode) {
        MoneyUtils.checkNotNull(roundingMode, "RoundingMode must not be null");
     ...
     */
    @NonNull
    public BigMoney withCurrencyScale(@NonNull RoundingMode roundingMode) {
     ...
     */
    @NonNull
    public BigMoney withAmount(@NonNull BigDecimal amount) {
        MoneyUtils.checkNotNull(amount, "Amount must not be null");
     ...
     * @throws CurrencyMismatchException if the currencies differ
     */
    private BigMoney checkCurrencyEqual(@NonNull BigMoneyProvider moneyProvider) {
     ...
     */
    @NonNull
    public BigMoney plus(@NonNull Iterable<? extends BigMoneyProvider> moniesToAdd) {
     ...
     */
    @NonNull
    public BigMoney plus(@NonNull BigMoneyProvider moneyToAdd) {
     ...
     */
    @NonNull
    public BigMoney plus(@NonNull BigDecimal amountToAdd) {
     ...
     */
    @NonNull
    public BigMoney plusRetainScale(@NonNull BigMoneyProvider moneyToAdd, @NonNull RoundingMode roundingMode) {
        BigMoney toAdd = checkCurrencyEqual(moneyToAdd);
     ...
     */
    @NonNull
    public BigMoney plusRetainScale(@NonNull BigDecimal amountToAdd, @NonNull RoundingMode roundingMode) {
        MoneyUtils.checkNotNull(amountToAdd, "Amount must not be null");
        if (amountToAdd.compareTo(BigDecimal.ZERO) == 0) {
            return this;
        }
     ...
     */
    @NonNull
    public BigMoney plusRetainScale(double amountToAdd, @NonNull RoundingMode roundingMode) {
        if (amountToAdd == 0) {
            return this;
        }
        BigDecimal newAmount = amount.add(BigDecimal.valueOf(amountToAdd));
     ...
     */
    @NonNull
    public BigMoney minus(@NonNull Iterable<? extends BigMoneyProvider> moniesToSubtract) {
        BigDecimal total = amount;
     ...
     */
    @NonNull
    public BigMoney minus(@NonNull BigMoneyProvider moneyToSubtract) {
     ...
     */
    @NonNull
    public BigMoney minus(@NonNull BigDecimal amountToSubtract) {
     ...
     */
    @NonNull
    public BigMoney minusRetainScale(@NonNull BigMoneyProvider moneyToSubtract, @NonNull RoundingMode roundingMode) {
        BigMoney toSubtract = checkCurrencyEqual(moneyToSubtract);
     ...
     */
    @NonNull
    public BigMoney minusRetainScale(@NonNull BigDecimal amountToSubtract, @NonNull RoundingMode roundingMode) {
        MoneyUtils.checkNotNull(amountToSubtract, "Amount must not be null");
        if (amountToSubtract.compareTo(BigDecimal.ZERO) == 0) {
            return this;
        }
     ...
     */
    @NonNull
    public BigMoney minusRetainScale(double amountToSubtract, @NonNull RoundingMode roundingMode) {
        if (amountToSubtract == 0) {
            return this;
        }
        BigDecimal newAmount = amount.subtract(BigDecimal.valueOf(amountToSubtract));
     ...
     */
    @NonNull
    public BigMoney multipliedBy(@NonNull BigDecimal valueToMultiplyBy) {
     ...
     */
    @NonNull
    public BigMoney multiplyRetainScale(@NonNull BigDecimal valueToMultiplyBy, @NonNull RoundingMode roundingMode) {
        MoneyUtils.checkNotNull(valueToMultiplyBy, "Multiplier must not be null");
        MoneyUtils.checkNotNull(roundingMode, "RoundingMode must not be null");
        if (valueToMultiplyBy.compareTo(BigDecimal.ONE) == 0) {
            return this;
     ...
     */
    @NonNull
    public BigMoney multiplyRetainScale(double valueToMultiplyBy, @NonNull RoundingMode roundingMode) {
     ...
     */
    @NonNull
    public BigMoney dividedBy(@NonNull BigDecimal valueToDivideBy, @NonNull RoundingMode roundingMode) {
     ...
     */
    @NonNull
    public BigMoney dividedBy(double valueToDivideBy, @NonNull RoundingMode roundingMode) {
        MoneyUtils.checkNotNull(roundingMode, "RoundingMode must not be null");
     ...
     */
    @NonNull
    public BigMoney dividedBy(long valueToDivideBy, @NonNull RoundingMode roundingMode) {
        if (valueToDivideBy == 1) {
            return this;
        }
        BigDecimal newAmount = amount.divide(BigDecimal.valueOf(valueToDivideBy), roundingMode);
     ...
     */
    @NonNull
    public BigMoney rounded(int scale, @NonNull RoundingMode roundingMode) {
        MoneyUtils.checkNotNull(roundingMode, "RoundingMode must not be null");
        if (scale >= getScale()) {
            return this;
        }
     ...
     */
    @NonNull
    public BigMoney convertedTo(@NonNull CurrencyUnit currency, @NonNull BigDecimal conversionMultipler) {
        MoneyUtils.checkNotNull(currency, "CurrencyUnit must not be null");
     ...
     */
    @NonNull
    public BigMoney convertRetainScale(@NonNull CurrencyUnit currency, @NonNull BigDecimal conversionMultipler, @NonNull RoundingMode roundingMode) {
     ...
     */
    @NonNull
    public Money toMoney(@NonNull RoundingMode roundingMode) {
     ...
     */
    public boolean isSameCurrency(@NonNull BigMoneyProvider money) {
     ...
     */
    @Override
    public int compareTo(@NonNull BigMoneyProvider other) {
     ...
     * @see #equals(Object)
     */
    public boolean isEqual(@NonNull BigMoneyProvider other) {
     ...
     * @throws CurrencyMismatchException if the currencies differ
     */
    public boolean isGreaterThan(@NonNull BigMoneyProvider other) {
        return compareTo(other) > 0;
    }
     ...
     * @throws CurrencyMismatchException if the currencies differ
     */
    public boolean isLessThan(@NonNull BigMoneyProvider other) {
        return compareTo(other) < 0;
    }
